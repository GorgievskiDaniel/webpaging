...
public class InMemorySongRepository {
    ...
    public void init(){
        ...
        songs.add(new Song(1L, "Blinding Lights", "Pop", 2020, List.of(allArtists.get(0)), allAlbums.get(0)));
        songs.add(new Song(2L, "Save Your Tears", "Pop", 2021, List.of(allArtists.get(1)), allAlbums.get(1)));
        songs.add(new Song(3L, "Sicko Mode", "Rap", 2018, List.of(allArtists.get(2)), allAlbums.get(2)));
        songs.add(new Song(4L, "God's Plan", "Rap", 2018, List.of(allArtists.get(3)), allAlbums.get(3)));
        songs.add(new Song(5L, "Thank U, Next", "Pop", 2020, List.of(allArtists.get(4)), allAlbums.get(4)));
    }
